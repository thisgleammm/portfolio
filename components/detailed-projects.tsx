...
const PROJECTS: Project[] = [
  {
    ...
    image: "/project-eco.jpg", // Placeholder until user adds real images
          ...
          {PROJECTS.map((project, index) => (
            ...
            >
              ...
              <div className="relative aspect-[16/10] w-full rounded-2xl overflow-hidden bg-accent-muted/20 border border-accent-muted/10 mb-8 overflow-clip">
                ...
                {/* Actual Image (commented out until user has files, using placeholder for now) */}
                {/* <Image 
                  src={project.image} 
                  alt={project.title} 
                  fill 
              ...
              <div className="flex flex-col flex-1 space-y-4">
                ...
                <div className="mt-auto flex items-center gap-6 pt-6 border-t border-accent-muted/10">
                  <a 
                    href={project.github} 
                    target="_blank" 
                    className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-all group/link"
                  >
                    <GitHubIcon />
                    Source
                  </a>
