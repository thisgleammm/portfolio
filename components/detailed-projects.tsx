...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: "2025",
    description: "Comprehensive workshop management application with real-time inventory tracking, customer billing, and service scheduling.",
    tech: ["Flutter", "Supabase", "Next.js"],
  ...
  },
  {
    title: "SEACATERING",
    year: "2025",
    description: "Full-stack catering management platform featuring automated menu planning and client order processing.",
  ...
  },
  {
    ...
    year: "2024",
    description: "Interactive e-learning management platform designed for streamlined student and course administration.",
  ...
  },
  {
    ...
    year: "2022",
    description: "Multi-purpose Discord utility bot with specialized moderation and social features.",
  ...
  },
  {
    ...
    year: "2021",
    description: "High-performance music streaming bot for Discord with playlist support and low-latency audio processing.",
    tech: ["Javascript", "Discord.js"],
